...
widgetMBDialog::widgetMBDialog(QString title, QString message, QStringList list, QWidget *parent, Qt::WindowFlags f):QDialog(parent,f),
    m_MainLayout(this),
    m_TitleBar  (this),
    m_SizeGrip  (NULL),
    //m_Cache     (NULL),
    background(NULL)
{
    ...
    m_MainLayout.addLayout(m_layoutButton,3,0);
...
/*QString widgetMBDialog::setFileName()
{
    //fileName = m_listWidget->currentItem()->text();
}*/

widgetMBDialog::~widgetMBDialog()
{
...
void widgetMBDialog::setWindowTitle(const QString &title)
{
  QWidget::setWindowTitle(title);
  emit WindowTitleChanged();
}

void widgetMBDialog::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
...
QString widgetMBDialog::getNameFile()
{
